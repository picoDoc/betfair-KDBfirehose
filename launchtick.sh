...
q tickerplant.q betfair hdb -p 5010 </dev/null >$KDBLOG/torqtp.txt 2>&1 &
q torq.q :5010 :5012 -load tick/r.q -p 5011 </dev/null >$KDBLOG/torqrdb.txt 2>&1 &
q torq.q -load hdb/betfair -p 5012 </dev/null >$KDBLOG/torqhdb.txt 2>&1 &
q torq.q -load code/processes/requestor.q -p 5009 </dev/null >$KDBLOG/requestor.txt 2>&1 &
...
#disown all jobs so they won't die when ssh sessions ends
disown -a
